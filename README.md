## Quick and dirty modification of PyRPL's FPGA

IQ0 and IQ1's modulation signal also modulates the frequency of ASG0 / ASG1 - IQ2's output modulates both ASG's frequencies at the same time.  
